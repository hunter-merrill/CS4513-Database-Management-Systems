...
(
    ...
    PRIMARY KEY (donor_id, check_number),
...
(
    ...
    PRIMARY KEY (visitor_id, program_name, park_name),
    CONSTRAINT FK_Enrollments_Visitors FOREIGN KEY (visitor_id) REFERENCES npss.visitors (visitor_id),
    CONSTRAINT FK_Enrollments_Programs FOREIGN KEY (program_name, park_name) REFERENCES npss.programs (program_name, park_name)
);
GO